...
%Outout: animal_filtertype powerbychannel.mat, with Power and NPower matrix in
...
elseif strcmp(probetype,'ECHIP512_3xTg1-2')==1
    numshanks=8;
    numchans=512;
    load([ana_dir '\probe_data\ECHIP512_3xTg1-2.mat'])
elseif strcmp(probetype,'128A')==1
    numchans=128;
    numshanks=2;
    load([ana_dir '\probe_data\probe128A.mat'])
...
%                     %if you want to eliminate seizure times
%                     if seizuretimes(b,1)>0 %define seizuretimes as boolean of seizure yes/no
%                         continue
%                     end
