...
e_M3r2DGhighR_c_ani = animal_ind(eM3_c);
e_M3r2DGhighR_c_ani = e_M3r2DGhighR_c_ani(e_M3highRind_c);
e_M3r2DGhighR_3wp_ani = animal_ind(eM3_3wp);
e_M3r2DGhighR_3wp_ani = e_M3r2DGhighR_3wp_ani(e_M3highRind_3wp);
e_M3r2DGhighR_8wp_ani = animal_ind(eM3_8wp);
e_M3r2DGhighR_8wp_ani = e_M3r2DGhighR_8wp_ani(e_M3highRind_8wp);
e_M3r2DGlowR_c_ani = animal_ind(eM3_c);
e_M3r2DGlowR_c_ani = e_M3r2DGlowR_c_ani(e_M3lowRind_c);
e_M3r2DGlowR_3wp_ani = animal_ind(eM3_3wp);
e_M3r2DGlowR_3wp_ani = e_M3r2DGlowR_3wp_ani(e_M3lowRind_3wp);
e_M3r2DGlowR_8wp_ani = animal_ind(eM3_8wp);
e_M3r2DGlowR_8wp_ani = e_M3r2DGlowR_8wp_ani(e_M3lowRind_8wp);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% prism output
savepath='L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\';
if exist(savepath)==0
     mkdir(savepath);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2CA1highR_c.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2CA1highR_3wp_ani, e_M3r2CA1highR_3wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2CA1highR_3wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2CA1highR_8wp_ani, e_M3r2CA1highR_8wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2CA1highR_8wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

% M32CA1_r_exc/inh - low R
table = rval_to_prism(e_M3r2CA1lowR_c_ani, e_M3r2CA1lowR_c);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2CA1lowR_c.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2CA1lowR_3wp_ani, e_M3r2CA1lowR_3wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2CA1lowR_3wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2CA1lowR_8wp_ani, e_M3r2CA1lowR_8wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2CA1lowR_8wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% M32DG_r_exc/inh - high R
table = rval_to_prism(e_M3r2DGhighR_c_ani, e_M3r2DGhighR_c);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2DGhighR_c.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2DGhighR_3wp_ani, e_M3r2DGhighR_3wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2DGhighR_3wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2DGhighR_8wp_ani, e_M3r2DGhighR_8wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2DGhighR_8wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

% M32DG_r_exc/inh - low R
table = rval_to_prism(e_M3r2DGlowR_c_ani, e_M3r2DGlowR_c);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2DGlowR_c.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2DGlowR_3wp_ani, e_M3r2DGlowR_3wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2DGlowR_3wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2DGlowR_8wp_ani, e_M3r2DGlowR_8wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2DGlowR_8wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 


% M32MEC_r_exc/inh - high R
table = rval_to_prism(e_M3r2MEChighR_c_ani, e_M3r2MEChighR_c);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2MEChighR_c.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2MEChighR_3wp_ani, e_M3r2MEChighR_3wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2MEChighR_3wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2MEChighR_8wp_ani, e_M3r2MEChighR_8wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2MEChighR_8wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% M32MEC_r_exc/inh - low R
table = rval_to_prism(e_M3r2MEClowR_c_ani, e_M3r2MEClowR_c);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2MEClowR_c.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2MEClowR_3wp_ani, e_M3r2MEClowR_3wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2MEClowR_3wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 

table = rval_to_prism(e_M3r2MEClowR_8wp_ani, e_M3r2MEClowR_8wp);
writetable(table, 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\prismrval\e_M3r2MEClowR_8wp.csv','Delimiter',',') %first col: name; second col: pval for kuipertest/Mann-Whitney test; third col: pval for ktest (for centralization). forth col: Wwtest (for equal means) 
