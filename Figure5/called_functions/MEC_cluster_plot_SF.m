%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% this script is to plot the MEC3 cluster plot in 0-720 degree range
% Note to change whether to inclue new LEC cells and what threshold to use in clustering
% Susie 4/6/23
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
hold off
savepath = 'L:\Susie\SummerEphysHPCEC\AnalysisOutput\HPCEC_analysis\singleunit_phaseloc\MECunits\theta\combinedcontrol_cluster\clusterMEC_plot\';
if exist(savepath)==0
    mkdir(savepath);
end
