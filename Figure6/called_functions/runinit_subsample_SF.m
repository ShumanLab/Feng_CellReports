%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% tthis is to calc the subsampled time bin's ratio over total time or total run time
% OUTPUT:
...
subsample_runinit_DGCA1_SF(animals)
...
subsample_runinit_M2MO_SF(animals)
...
subsample_runinit_M2M3_SF(animals)
