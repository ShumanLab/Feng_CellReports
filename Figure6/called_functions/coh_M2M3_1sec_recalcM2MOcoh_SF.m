function coh_M2M3_1sec_recalcM2MOcoh_SF(animals)
...
%             M2M3_aligned_ind_run = align_ind_run;
            ...
            %M2MOcoh_whenalignM2M3 = coh_matrix_run(find(M2M3_aligned_ind_run == 1));
           ...
           for i = 1: length(run_matrix)
            ...
            M2MOcoh_whenalignM2M3 = coh_matrix(find(M2M3_aligned_indandrun == 1));

        elseif group == '3wC' | group == '8wC' 
            load([exp_dir '\M2MOcoh_1sec.mat'],'coh_matrix', 'coh_matrix_run', 'track','run_matrix');  
            M2MOcoh_whenalignM2M3 = coh_matrix_run;
        end

         coh_ave = nanmean(M2MOcoh_whenalignM2M3);
         if group == '3wP'
    ...
    save([savepath '\M2MO_coh_whileM2M3Colalign_running_3secconsec.mat'],'coh_ave_3wp','coh_ave_8wp', 'coh_ave_3wc', 'coh_ave_8wc','coh_ave_8wc_ani','coh_ave_3wc_ani','coh_ave_8wp_ani','coh_ave_3wp_ani');
