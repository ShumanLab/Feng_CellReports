%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% this script is to generate new aligned index mat based on alined M2M3 coh
...
isaligning = 0;
    ...
    if group == '3wP' | group == '8wP' 
        load([exp_dir '\M2M3coh_1sec.mat'],'coh_matrix', 'coh_matrix_run', 'aligned_coh_matrix', 'track','run_matrix' , 'align_ind_run', 'align_ind');    %, 'align_ind_run', 'align_ind'); %use the ind to find timebin in M2MO
...
%%%%%%%%%%%%%%%%   This is for align_ind_run_3sec_consec     
    ...
    save([exp_dir '\M2M3coh_1sec.mat'],'coh_matrix', 'coh_matrix_run', 'aligned_coh_matrix', 'track','run_matrix' , 'align_ind_run', 'align_ind', 'align_ind_3sec_consec', 'align_ind_run_3sec_consec'); 
