function coh_M2M3align_1sec_DG2CA1_PL_recalc_SF(animals)
    for a = 1:length(animals)
        ...
        for shk = 1:length(shanks)
            ...
            save(['Y:\Susie\2020\Summer_Ephys_ALL\kilosort\' animal '\shank' num2str(shank) 'DGCA1_PL_whenM2M3cohalign_running1sec_2sec_consec.mat'],'units') %save final units info as shank_units.mat in animal folder under kilosort
