function coh_M2MO_1sec_recalcDGCA1coh_SF(animals)
...
%             M2MO_aligned_ind_run = align_ind_run;
            ...
            %DGCA1coh_whenalignM2MO = coh_matrix_run(find(M2MO_aligned_ind_run == 1));
           ...
           for i = 1: length(run_matrix)
            ...
            DGCA1coh_whenalignM2MO = coh_matrix(find(M2MO_aligned_indandrun == 1));

        elseif group == '3wC' | group == '8wC' 
            load([exp_dir '\DGCA1coh_1sec.mat'],'coh_matrix', 'coh_matrix_run', 'track','run_matrix');  
            DGCA1coh_whenalignM2MO = coh_matrix_run;
        end

         coh_ave = nanmean(DGCA1coh_whenalignM2MO);
         if group == '3wP'
    ...
    save([savepath '\DGCA1_coh_whileM2MOColalign_running_3secconsec.mat'],'coh_ave_3wp','coh_ave_8wp', 'coh_ave_3wc', 'coh_ave_8wc','coh_ave_8wc_ani','coh_ave_3wc_ani','coh_ave_8wp_ani','coh_ave_3wp_ani');
