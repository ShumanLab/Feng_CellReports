%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% this script is out put HPC, MEC. MEC/HPC subsampled time bin index for furthur process in python (loc ana)
% OUTPUT:Y:\Susie\2020\Summer_Ephys_ALL\analysis\HPCEC_analysis\subsample_ana\new_1sec\0.5SD\OUTPUT_subsample_ind: animal_regionalign_ind
% Susie 6/23/24
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
OUTPUT_subsample_DGCA1_idx_SF(animals)
...
OUTPUT_subsample_M2MO_idx_SF(animals)
...
OUTPUT_subsample_M2M3_idx_SF(animals)